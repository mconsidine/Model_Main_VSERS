...
results_all <- get_results(IO_folder, "^Outputs_D") # This will take a while because of the large size of output files that contain demographic data #MattC uncommented
save(results_all, file = paste0(IO_folder, "/Analysis_Demo/Demo_results_all.RData")) #MattC uncommented

## Outputs of demographics
source("IO_M2.1_new/Report_M2.1a_LoadingDemoData.R") #MattC uncommented
outputs.folder  <- "/M2.1a_outputs/" #MattC restablish
