...
run_knitr <- TRUE #set to TRUE before knitting.
...
```{r shock, message=TRUE, warning=TRUE, paged.print=TRUE}
...
draw_quantiles(c(paste0(prefix, runs_M1_shock)), "FR",    ylim = c(0, 250),
               year.max = 30)$plot %>% print
#draw_quantiles(c(paste0(prefix, runs_M1_shock)), "C_PR",   ylim = c(-2, 35),  year.max = 20)$plot %>% print
draw_quantiles(c(paste0(prefix, runs_M1_shock)), "ERC_PR", ylim = c(-2, 35),
               year.max = 30)$plot %>% print
