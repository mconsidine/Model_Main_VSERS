...
plan_params$include<-as.logical(plan_params$include) #MattC values should be formatted as numeric in sheet first
plan_params$save.indiv<-as.logical(plan_params$save.indiv) #MattC may not be necessary based on ssheet?
plan_params$no_entrance<-as.logical(plan_params$no_entrance) #MattC
plan_params$exCon<-as.logical(plan_params$exCon) #MattC
plan_params$nonNegC<-as.logical(plan_params$nonNegC) #MattC
plan_params$EEC_fixed<-as.logical(plan_params$EEC_fixed) #MattC
