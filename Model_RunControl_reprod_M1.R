...
plan_params$include<-as.logical(plan_params$include) #MattC may not be necessary based on ssheet format?
plan_params$save.indiv<-as.logical(plan_params$save.indiv) #MattC
